...
def preprocess_dataset():
    ...
    real_video_ratio = 1  # For example, 100% of all real videos
    fake_video_ratio = 1  # For example, 100% of all fake videos

    # Existing input and output folders
    input_folders = [
        "data/Celeb-real",
        "data/Celeb-synthesis",
        "data/YouTube-real",
        "data/faceforensics/real",   # Added new real folder
        "data/faceforensics/fake"    # Added new fake folder
    ]
    output_folders = [
        "data/preprocessed/Celeb-real",
        "data/preprocessed/Celeb-synthesis",
        "data/preprocessed/YouTube-real",
        "data/preprocessedfaceforensics/real",  # Output folder for faceforensics real
        "data/preprocessedfaceforensics/fake"   # Output folder for faceforensics fake
    ]
    ...
    for input_folder, output_folder in zip(input_folders, output_folders):
        ...
        if is_real:
            ...
            if fake_remaining <= 0:
                ...
                continue
            # If fake_remaining > available videos, just take them all
    ...
    if not preprocess_args:
        logging.warning("No videos to preprocess. Exiting.")
        return

    # Determine the number of processes to use
    num_processes = min(cpu_count(), 8)  # Adjust based on your system
    ...
    # Include all preprocessed folders including the new faceforensics ones
    real_preprocessed_folders = [
        "data/preprocessed/Celeb-real",
        "data/preprocessed/YouTube-real",
        "preprocessedfaceforensics/real"  # Include faceforensics real
    ]
    fake_preprocessed_folders = [
        "data/preprocessed/Celeb-synthesis",
        "preprocessedfaceforensics/fake"   # Include faceforensics fake
    ]
